...
DECLARE
    -- Объявление ассоциативного массива.
		TYPE ENAME_TYPE IS TABLE OF SCOTT.EMP.ename%TYPE
    INDEX BY PLS_INTEGER;
    TYPE LOC_TYPE   IS TABLE OF SCOTT.DEPT.loc%TYPE
    INDEX BY PLS_INTEGER;
...
BEGIN
     ...
     LOOP
       dbms_output.put_line(lpad(l_row,2,' ')||' ' || rpad(t_ename(l_row),7,' ') || t_loc(l_row));
